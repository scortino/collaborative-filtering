...
class MovieRatingsGenerator2(object):
    ...
    def _prepare_data(self):
        ...
        for user in range(1, self.n_raters + 1):
    ...
    def predict_rating(self, user, movie, k, neighbors=None):
        ...
        actual_ratings = ratings_of_movie.iloc[neighbors-1] + self.average_rating_of_user[user]
